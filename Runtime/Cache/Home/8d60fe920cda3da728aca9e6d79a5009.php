...
<head>
	...
	<link rel="stylesheet" href="/Public/css/seatTest.css">
	<title>图书馆选座界面</title>
</head>
...
<div class="hdu_lib_floors">
	...
	<div class="fixed_top_nav_mask"><!-- 座位图标指示标题栏 -->
		<div class="hdu_describe_nav">
			<div class="empty_seat_style" >
				<div ><img src="/Public/img/座位 (空).png" alt=""><span>空位</span></div>
				<div ><img src="/Public/img/选中.png" alt=""><span>我的选择</span></div>
			</div>
			<div class="order_seat_style">
				<div><img src="/Public/img/座位 (男预约).png" alt=""><span>预约(男生)</span></div>
				<div><img src="/Public/img/座位 (女预约).png" alt=""><span>预约(女生)</span></div>
			</div>
			<div class="ocupy_seat_style">
				<div><img src="/Public/img/座位 (男在).png" alt=""><span>座位(男生)</span></div>
				<div><img src="/Public/img/座位 (女在).png" alt=""><span>座位(女生)</span></div>
			</div>
		</div>
	</div>
	...
	<form id="chooseSeatForm" method="post" action="">
		<input id="chooseId" type="text" name="choosed_seat_id" hidden>
...
<script type="text/javascript">
	...
	function chooseConfirm () {
		...
		//     url:"http://localhost:8180/libraryP/test_json_encode.php",
		//     data:{
		//     	// user:,
	...
	function refreshSeatShow(){
		...
		$("#seat_confirm").attr("disabled",true);
			...
			$.ajax({
				async:false,
				type:"GET",
				url:"/index.php/home/seatselection/seatdistribution",
				dataType:"json",
				success:function(data){
					seat_y=data.seat_y;
					seat_x=data.seat_x;
