...
<body>
	...
	<div class="d4"><p>二楼自习室<?php echo $_SESSION['seat_id'];?>座</p><p>预约时间：<?php echo $_SESSION['start_time'];?></p><p>签到截至时间:<?php echo $_SESSION['end_time'];?></p></div>
	<div class="d5"><p>预约者信息：</p><p>学号：<?php echo $_SESSION['number'];?></p><p>姓名：<?php echo $_SESSION['name'];?></p>
