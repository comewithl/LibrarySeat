	...
	function chooseConfirm () {
		var choosed_id=$(choosed_seat).attr("id");
		 jQuery.ajax({
		     ...
		     url:"/index.php/home/seatselection/seatselect02",
		     data:{
		     	// user:,
		     ...
		     success:function($date){
				 if($date == 0){
					 ...
					 alert("恭喜你！选座成功！");
					 window.location.href = "/index.php/home/seatinfo/seatinfoyuyue";
				 }
		     },
	...
	function refreshSeatShow(){
		...
		$("#seat_confirm").attr("disabled",true);
			...
			$.ajax({
				async:false,
				type:"GET",
				url:"/index.php/home/seatselection/seatdistribution02",
				dataType:"json",
