...
<body>
	...
	<div class="d5">
		...
		<img class="no-sign" src="/Public/img/暂离.png" >
	</div>
	<div class="d6">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$.ajax({
			type:"GET",
			url:"/index.php/home/seatinfo/zanliinfo",
			datatype:"json",
	...
	$(".btn-tz").click(function(){
		//$.post("/index.php/home/seatinfo/yuyuetuizuo",{"number":info["number"]});
		$.ajax({
			type:"POST",
			url:"/index.php/home/seatinfo/zanlituizuo",
			success:function(data){
				alert(data);
				window.location.href="/index.php/home/floorlist/floorlist?userId="+info["number"];
			},
